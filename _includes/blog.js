...
var toggle = document.querySelector('.post-header-toggle');
var siteHeader = document.querySelector('.post-header')
...
//
// Anchor.js for in-page anchor scrolling
//

anchors.options = {
  icon: '#'
}
anchors.add('.markdown-body > h2, .markdown-body > h3, .markdown-body > h4, .markdown-body > h5')
